  ...
  return (
    <header className="w-full bg-white z-40 sticky top-0 shadow-xs">
      ...
      <div className="bg-[#f4f4f4] border-y border-gray-200/80">
        <div className="hidden lg:flex items-center justify-center gap-8 sm:gap-10 py-1 max-w-7xl mx-auto px-4 font-['Barlow_Condensed',sans-serif] text-[18px] sm:text-[19px] font-bold tracking-[0.04em] uppercase text-[#1a1a1a] leading-tight">
          <a href="/collections" className="text-[#e62b32] hover:opacity-80 transition-colors">
            SHOP
          </a>
          <a
            href="/sale"
            className="bg-[#e62b32] text-white px-3.5 py-0.5 rounded-[4px] text-[15px] font-extrabold hover:bg-[#cf2229] transition-colors shadow-2xs tracking-[0.04em] leading-tight inline-flex items-center justify-center"
          >
            SALE
          </a>
